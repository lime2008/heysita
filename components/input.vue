<template>
  <div class="el-input">
    ...
    ></component>
    <div
      v-if="showCharCounter && maxChars"
      class="char-counter"
      :class="{'input_counter' : !isTextarea , 'textarea_counter' : isTextarea}"
    >
      {{ inputValue.toString().length }} / {{ maxChars }}
    </div>
  </div>
</template>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      showCharCounter: { type: Boolean, default: true },
    },
